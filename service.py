	...
	def run(self):
		try:
			...
			if isUpdate:
				...
				clearDB_version = '6.2.1' # set to desired version to force any db clearing needed
				...
				if do_cacheClear:
					...
					clr_traktSync = {'bookmarks': False, 'liked_lists': True, 'hiddenProgress': False, 'movies_collection': False, 'shows_collection': False, 'movies_watchlist': False, 'shows_watchlist': False, 'user_lists': True}

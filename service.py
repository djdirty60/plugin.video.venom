	...
	def run(self):
		try:
			...
			if isUpdate:
				...
				clearDB_version = '6.2.2' # set to desired version to force any db clearing needed
				...
				if do_cacheClear:
					...
					clr_traktSync = {'bookmarks': False, 'hiddenProgress': False, 'liked_lists': False, 'movies_collection': False, 'movies_watchlist': False, 'popular_lists': False,
								'service': False, 'shows_collection': False, 'shows_watchlist': False, 'trending_lists': False, 'user_lists': False}
